...
const Home: React.FC = () => {
    return (
        <main className=" h-fit pt-4 pb-6 md:px-8 px-4 flex flex-col items-center bg-gradient-to-b from-[#d6dbdc] to-[#ffffff]">
            ...
            <div className="flex flex-col items-center justify-center text-center pt-8 pb-4 max-w-3xl space-y-4 ">
